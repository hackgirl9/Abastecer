...
<body>
    ...
    <img src="Assets/img/big-logo.jpg" class="img" width="300px" >  
     <h2 class="titulo">Informe Solicitud</h2>
     <p class="fecha"><?php echo $fecha= date("d/m/Y")?></p>
    </div>
    <div class="cint"><i class="icon-assignment_ind"></i> <h4 class="center">Datos de Solicitantes</h4></div>
        ...
        <div class="tabla">
            <table border="1" width="1000px">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo ucwords($resultado->nOficio)?></td>
                        ...
                        <td><?php echo ucwords($resultado->fechaSolicitud)?></td>
                        <td><?php echo ucwords($resultado->statusSolicitud)?></td>
                        <td><?php echo ucwords($resultado->beneficioSolicitud)?></td>
