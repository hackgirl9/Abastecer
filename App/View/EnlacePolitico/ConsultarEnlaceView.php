                        ...
                        <div class="col s12">
                            ...
                            <div class="col s12 center-align">
                                ...
                                <ul class="pagination">
                                    ...
                                    <?php endif; if($page > 1): ?>
                                    <li class="waves-effect"><a href="<?php echo $helper->url('EnlacePolitico','readData')?>&p=<?php echo $previous; ?>"><i class="icon-navigate_before"></i></a></li>
                                    <?php endif; ?>
                                    <?php for($i = 1; $i <= $totalPagina; $i++): ?>
                                    <li class="<?php if(isset($page)&& $page == $i){ echo "active teal-45deg-gradient-1"; } ?>"><a href="<?php echo $helper->url('EnlacePolitico','readData')?>&p=<?php echo $i ?>"><?php echo $i ?></a></li>
                                    <?php endfor; ?>
                                    <?php if($page == $totalPagina): ?>
                                    <li class="disabled"><a href="#!"><i class="icon-navigate_next"></i></a></li>
                                    <?php endif; if($page != $totalPagina): ?>
                                    <li class="waves-effect"><a href="<?php echo $helper->url('EnlacePolitico','readData')?>&p=<?php echo $next; ?>"><i class="icon-navigate_next"></i></a></li>
                                    <?php endif; ?>
                                </ul>
                            </div>
                        <?php endif; ?>
